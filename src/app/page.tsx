...
import { pricingCards } from "@/constantes/landing-page";
import clsx from "clsx";
import { Check } from "lucide-react";
import Image from "next/image";
import Link from "next/link";
import parse from "html-react-parser";
import { onGetBlogPosts } from "@/actiions/landing";
      ...
      <section>
        <div className="flex items-center justify-center flex-col mt-[80px] gap-4 ">
          <span className="text-orange bg-orange/20 px-4 py-2 rounded-full text-sm">
            {/* An AI powered sales assistant chatbot */} Luxus AI is an powered sales assistant 
          </span>
          <Image
            ...
            <Link href={`/blogs/${post.id}`} key={post.id}>
              <Card className="flex flex-col gap-2 rounded-xl overflow-hidden h-full hover:bg-gray-100">
                ...
                <div className="py-5 px-10 flex flex-col gap-5 ">
                  ...
                  <CardTitle>{parse(post.title)}</CardTitle>
